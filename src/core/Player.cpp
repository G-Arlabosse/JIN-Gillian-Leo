...
Player::Player(const b2WorldId& worldId, float pos_x, float pos_y, TextureManager* textureManager, LevelMediator* levelMediator, bool renderDebugBoxes) :
	Entity(worldId, pos_x, pos_y, 20, playerHitbox, textureName::STRAWBERRY, textureManager,
